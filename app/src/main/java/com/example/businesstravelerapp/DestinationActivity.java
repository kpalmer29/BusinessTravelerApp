...
public class DestinationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String originCountry = caller.getStringExtra("Country");
        ...
        selectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (curr != 0) {
                    ...
                    goToSecond.setClass(getApplicationContext(), CityActivity.class);
                    goToSecond.putExtra("OriginCountry", originCountry);
                    goToSecond.putExtra("DestinationCountry", country);
